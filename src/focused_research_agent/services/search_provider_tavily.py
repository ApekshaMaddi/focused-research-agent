...
class TavilySearchClient(SearchProvider):
    ...
    def _validate_queries(self, queries: list[str]) -> list[str]:
        ...
        Raises:
            ValueError: If queries is not a non-empty list of non-empty strings.
        """
    ...
    def _validate_tavily_response(self, response: object, query: str) -> list[dict]:
    ...
    def _normalize_result(self, item: dict, query: str) -> SearchResult | None:
        ...
        Returns:
            SearchResult | None: Normalized result if valid, otherwise None.
        """
    ...
    def _search_single_query(self, query: str) -> list[SearchResult]:
        """Run Tavily search for one query and normalize the returned results.
            ...
            Raises:
                ValueError: If the Tavily response shape is invalid or a result item
                    is malformed.
            """
