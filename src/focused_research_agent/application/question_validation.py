"""
Shared question-validation helpers for the Focused Research Agent.

This module contains transport-neutral validation logic for user research
questions. The same validation rules can be reused by FastAPI request
schemas, the application layer, and future UI layers.

Architecturally, this belongs to the application layer because it validates
the quality of use-case input without depending on HTTP, CLI, or UI details.
"""
